...
function UserSearch() {
    ...
    //const {users, searchUsers, clearUsers} = useContext(GithubContext)        whithout GithubActions
    ...
    return (
        <div className="grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 mb-8 gap-8">
            ...
            {users.length > 0 && (
            <div>
                <button className="btn btn-ghost btn-large" onClick={handleClear}>Clear</button>
            </div>
            )}
        </div>
    )
